...
SS_CALL_MDL_OUTPUTS ) ; _rtB -> hduevjx32i = - _rtB -> oyx5yfdzev - 2.0 *
_rtB -> oyx5yfdzev * _rtB -> bdd1xty4ee ; _rtB -> c0vdjcdysr = 2.0 * _rtB ->
bdd1xty4ee * _rtB -> oyx5yfdzev + _rtB -> bdd1xty4ee ; UNUSED_PARAMETER ( tid
) ; }
#define MDL_UPDATE
...
mdlInitializeSizes ( SimStruct * S ) { ssSetChecksumVal ( S , 0 , 354836276U
) ; ssSetChecksumVal ( S , 1 , 1822681819U ) ; ssSetChecksumVal ( S , 2 ,
3785123709U ) ; ssSetChecksumVal ( S , 3 , 3824063215U ) ; { mxArray *
